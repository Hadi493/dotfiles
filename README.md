...
- [Wlogout](https://github.com/ArtsyMcFly/wlogout)
...
- [Brightnessctl](https://github.com/Hummer120/brightnessctl)
- [Pactl](https://linux.die.net/man/1/pactl)
- [Wpctl](https://pipewire.pages.freedesktop.org/pipewire/man/wpctl.1.html)
